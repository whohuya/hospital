<template>
  <div v-loading="loading" class="page-container" :key="appManageSetting">
    ...
    <app-add
      @close="appAddDialog = false"
      :innerVisible="appAddDialog"
      v-model="initData"
      :modify="modifyFlag"
    ...
    <app-record
      ref="appRecord"
      @close="appRecordDialog = false"
      :innerVisible="appRecordDialog"
      v-model="initData"
      widthSet="900px"
      :modify="modifyFlag"
      @modifyClose="modifyFlag = false"
...
export default {
  ...
  data() {
    return {
      ...
      defineBtn: [
        {
          ...
          showBtn: ifAuthority("appManage","ADD"),
        },
      ],
      ...
      keyAdd: 0,
      btnLoading: false,
      upgrade: ifAuthority('appManage', "UPGRADE"),
      verhistory: ifAuthority('appManage', "VERHISTORY"),
    };
  },
  computed: {
    ...mapState({
